...
def _launch_windows(app_name: str) -> bool:
    # Never pass model/user-controlled text through cmd.exe.  Besides command
    # injection, shell=True also makes quoting paths with spaces unreliable.
    ...
    # Windows URI handlers (for example ms-settings:) are safe through
    # ShellExecute/os.startfile as long as the value is a single URI rather
    # than shell syntax.
